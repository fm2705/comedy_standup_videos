 ...
 */
@WebServlet("/admin/list_most_productive_users")
public class ListProductiveUsersServlet extends BaseServlet {
	private static final long serialVersionUID = 1L;
       
  
    public ListProductiveUsersServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
		...
		userServices.listProductiveUsers(null);
	}
