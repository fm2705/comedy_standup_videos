...
/**
 * Userv1Id generated by hbm2java
 */
@Embeddable
public class Userv1Id implements java.io.Serializable {
	...
	public Userv1Id(String email, String password, String gender, Integer personId, String street, String city,
			String state) {
		this.email = email;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Userv1Id))
			return false;
		Userv1Id castOther = (Userv1Id) other;
